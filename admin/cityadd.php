...
if(isset($_POST['insert']))
{
	...
	if(!empty($state) && !empty($city)){
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>Thành phố đã được thêm thành công!</p>";
						
			}
			else
			{
				$error="<p class='alert alert-warning'>Thành phố không được thêm thành công!</p>";
			}
	}
	else{
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">Thêm thành phố</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
								...
								<form method="post" id="insert product" enctype="multipart/form-data">
									<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													...
													<div class="form-group row">
														<label class="col-lg-3 col-form-label">Tên khu vực</label>
														<div class="col-lg-9" >	
											...
											<div class="text-left">
												<input type="submit" class="btn btn-primary"  value="Submit" name="insert" style="margin-left:150px;">
											</div>
									</div>
								</form>
							</div>
									...
									<table id="basic-datatable" class="table table-bordered table-hover">
											...
											?>
                                                <tr>
                                                   ...
                                                   <a href="citydelete.php?id=<?php echo $row['0']; ?>"><input type="submit" value="Delete" class="btn btn-danger" onclick="return confirm('Bạn chắc chắn muốn xóa thành phố này?');" name="delete"></a></td>
                                                </tr>
                                                <?php $cnt=$cnt+1; } ?>
