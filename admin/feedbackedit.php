...
if(isset($_POST['update']))
{
	...
	if($result == true)
		{
			$msg="<p class='alert alert-success'>Nội dung đã được duyệt!</p>";
			header("Location:feedbackview.php?msg=$msg");		
		}
		else
		{
			$msg="<p class='alert alert-warning'>Nội dung chưa được duyệt!</p>";
			header("Location:feedbackview.php?msg=$msg");
		}
}
?>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h2 class="card-title">Cập nhật phản hồi và báo cáo</h2>
								</div>
								<?php 
								$fid = $_GET['id'];
								...
								<div class="card-body">
										<div class="row">
											<div class="col-xl-12">
												<h5 class="card-title">Cập nhật phản hồi và báo cáo</h5>
												
												<?php echo $msg; ?>
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Mã phản hồi</label>
													<div class="col-lg-9">
										...
										<div class="text-left">
											<input type="submit" class="btn btn-primary"  value="Submit" name="update" style="margin-left:224px;">
										</div>
									</form>
									<?php } ?>
								</div>
