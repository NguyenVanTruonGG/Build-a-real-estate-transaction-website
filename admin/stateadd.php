...
if(isset($_POST['insert']))
{
	...
	if(!empty($state)){
		...
		if($result)
			{
				$msg="<p class='alert alert-success'>Khu vực đã được thêm thành công!</p>";
						
			}
			else
			{
				$error="<p class='alert alert-warning'>Khu vực không được thêm thành công!</p>";
			}
	}
	else{
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h1 class="card-title">Thêm khu vực</h1>
									<?php echo $error;?>
									<?php echo $msg;?>
									<?php 
										if(isset($_GET['msg']))	
									...
									<table id="basic-datatable " class="table table-bordered table-hover">
											...
											?>
                                                <tr>
                                                    ...
                                                    <a href="statedelete.php?id=<?php echo $row['0']; ?>"><input type="submit" value="Delete" class="btn btn-danger" onclick="return confirm('Bạn chắc chắn muốn xóa khu vực này?');" name="delete"></a></td>
                                                </tr>
                                                <?php $cnt=$cnt+1; } ?>
