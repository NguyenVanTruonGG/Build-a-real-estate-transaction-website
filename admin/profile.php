							...
							<div class="profile-header">
								<div class="row align-items-center">
									...
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-2 text-uppercase p-3"><?php echo $row['1']; ?></h4><div class="card">
										<div class="col-lg-4">
										<button class="btn btn-success" type="button"><i class="fe fe-check-verified"></i> Đang hoạt động</button>
										</div>
