                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
							$query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage,DATE_ADD(date, INTERVAL 7 DAY) AS new_date FROM `property`,`user` WHERE property.uid=user.uid AND CURDATE() <= DATE_ADD(date, INTERVAL 7 DAY)");
                    ...
                    <div class="col-lg-4">
                        ...
                        <ul class="property_list_widget">
                            ...
                            <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                ...
                                <span class="font-14"><i class="fas fa-map-marker-alt icon-success icon-small"></i> <?php echo $row['15'];?> - </i> <?php echo $row['16'];?></span>
